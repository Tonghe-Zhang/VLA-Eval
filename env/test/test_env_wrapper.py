...
from env.info_overlay_wrapper import InfoOverlayWrapper  # NEW!
...
def main(cfg: DictConfig):
    ...
    wrappers = [
        ...
        partial(InfoOverlayWrapper),  # NEW!
    ]
    ...
    print(f"RGB observation keys: {list(obs_rgb.keys())}")
    for camera_name, img in obs_rgb.items():
    ...
    for step in tqdm(range(num_test_steps)):
        ...
        obs_rgb = fetch_rgb_from_obs_allenvs(env_type, rendered_img, sim_device, model_device)
